			...
			<div class="container">
				<div class="buttons-container">
					...
					<div class="puppy-button-container">
						<button class="btn btn-lg btn-primary col-md-3 col-xs-6" id="puppy-button"
								  onclick="replacePuppy()">Puppy!</button>
					</div>
					<div class="koi-button-container">
						<button class="btn btn-lg btn-warning col-md-3 col-xs-6" id="koi-button" onclick="replaceKoi
						()">Koi!</button>
					</div>
					<div class="platypus-button-container">
						<button class="btn btn-lg btn-info col-md-3 col-xs-6" id="platypus-button"
								  onclick="replacePlatypus()">Platypus?</button>
					</div>
				</div>
